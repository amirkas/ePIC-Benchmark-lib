...
from epic_benchmarks.parsl.executors import HighThroughputExecutorConfig, ThreadPoolExecutor, ParslExecutorConfig
from epic_benchmarks.parsl.providers import SlurmProviderConfig, LocalProviderConfig

class PerlmutterHtecConfig(HighThroughputExecutorConfig):
    ...
    worker_debug: bool = Field(init=False, default=None)
