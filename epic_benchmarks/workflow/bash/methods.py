...
def checkout_epic_branch(workflow_config : WorkflowConfig, benchmark_name : str, inputs=[], outputs=[], stdout=AUTO_LOGNAME, stdin=AUTO_LOGNAME) -> str:
...
def compile_epic(workflow_config : WorkflowConfig, benchmark_name : str, num_threads : int = 1, inputs=[], outputs=[], stdout=AUTO_LOGNAME, stdin=AUTO_LOGNAME) -> str:
...
def run_npsim(workflow_config : WorkflowConfig, benchmark_name : str, simulation_name : str, inputs=[], outputs=[], stdout=AUTO_LOGNAME, stdin=AUTO_LOGNAME) -> str:
...
def run_eicrecon(workflow_config : WorkflowConfig, benchmark_name : str, simulation_name : str, inputs=[], outputs=[], stdout=AUTO_LOGNAME, stdin=AUTO_LOGNAME) -> str:
