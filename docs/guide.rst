...
Retrieving BenchmarkConfig and SimulationConfig instances
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
The methods to access these paths are listed in the API reference in :ref:`this section <_paths_api>` for more.
...
Saving a WorkflowConfig to a file
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
Loading a WorkflowConfig from a file
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
